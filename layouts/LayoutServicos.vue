<template>
  <div>
    ...
    <Home />
    <main>
      <Sobre id="sobre" class="pt-100" />
    </main>
    <Valores />
    <Destaques />
    <section class="bg-dark py-80">
      <Nuxt id="servicos" />
    </section>
    <Numeros />
    <ProvasSociais />
...
export default {
  components: { Navbar, Home, Valores, Destaques, Sobre, Numeros, Contato, Footer, ProvasSociais, ModalWhatsapp, BtnWhatsappFlutuante, Cookie },
  mounted () {
