  ...
  <div class="container">
    ...
    <div class="mt-xs-20 mt-sm-20 mt-md-50">
      <h3 class="col-md-5 mb-xs-30 mb-sm-30 mb-md-10 mr-3 text-xs-center text-sm-center text-md-left px-0 fw-700 float-left">
        A Excellence <span class="text-vermelho">está em Évora</span> a mais de 25 anos
      ...
      <section class="col-12 px-0">
        <div class="container px-xs-0">
          ...
          <div class="position-relative border shadow border-radius-10 mt-30 overflow-hidden col-12 d-flex row mx-auto pr-0 pt-1 pb-30 pl-65">
            ...
            <a class="d-flex col-12 mt-4 px-0 py-0 text-preto-cidades fs-sm-18 fw-600 btn align-items-center" @click.prevent="Evora">
              <ion-icon class="fs-20 text-vermelho mr-2" name="navigate-outline" /> Évora
            </a>
          </div>
        </div>
      </section>
...
export default {
  ...
  layout: 'LayoutSobre',
  head: {
    title: 'Excellence - Detetive particular em Évora'
  },
  mounted () {
    this.$smoothScroll({
