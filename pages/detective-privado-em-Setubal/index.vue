  ...
  <div class="container">
    ...
    <div class="mt-xs-20 mt-sm-20 mt-md-50">
      ...
      <p class="fw-500 text-justify">
        Se você está procurando um Detective Privado em Setúbal acabou de encontrar!
      </p>
      <p class="fw-500 text-justify">
        A Excellence Agência de Detectives Privados está em Setúbal a mais de 25 anos proporcionando a seus clientes
...
export default {
  ...
  layout: 'LayoutSobre',
  head: {
    title: 'Excellence - Detective privado em Setúbal'
  },
  mounted () {
    this.$smoothScroll({
