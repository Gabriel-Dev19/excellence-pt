  ...
  <div class="container">
    ...
    <div class="mt-xs-20 mt-sm-20 mt-md-50">
      ...
      <p class="fw-500 text-justify">
        Se você está procurando um Detective Privado em Viana do Castelo acabou de encontrar!
      </p>
      <p class="fw-500 text-justify">
        A Excellence Agência de Detectives Privados está em Viana do Castelo a mais de 25 anos proporcionando a seus clientes
...
export default {
  ...
  layout: 'LayoutSobre',
  head: {
    title: 'Excellence - Detective privado em Viana do Castelo'
  },
  mounted () {
    this.$smoothScroll({
