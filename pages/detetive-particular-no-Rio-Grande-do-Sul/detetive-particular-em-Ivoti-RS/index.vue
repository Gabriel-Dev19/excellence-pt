  ...
  <div class="container">
    ...
    <div class="mt-xs-20 mt-sm-20 mt-md-50">
      <h3 class="col-md-5 mb-xs-30 mb-sm-30 mb-md-10 mr-3 text-xs-center text-sm-center text-md-left px-0 fw-700 float-left">
        A Excellence <span class="text-vermelho">está em Ivoti - RS</span> a mais de 25 anos
        proporcionando a seus clientes <span class="text-vermelho">a verdade que eles tanto buscam.</span>
      </h3>
      <p class="fw-500 text-justify">
        Se você está procurando um Detetive Particular em Ivoti - RS acabou de encontrar!
      </p>
      <p class="fw-500 text-justify">
        A Excellence Agência de Detetives Particulares está em Ivoti - RS a mais de 25 anos proporcionando a seus clientes
...
export default {
  ...
  layout: 'LayoutSobre',
  head: {
    title: 'Excellence - Detetive particular em Ivoti - RS'
  },
  mounted () {
    this.$smoothScroll({
